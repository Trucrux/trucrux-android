...
IMX_DEVICE_PATH := device/nxp/imx8m/trux_mx8mq

PRODUCT_IMX_DRM := true

# copy drm specific files before inherit trux_mx8mq.mk, otherwise copy is ignored
PRODUCT_COPY_FILES += \
...
$(call inherit-product, $(TOPDIR)$(IMX_DEVICE_PATH)/trux_mx8mq.mk)

TARGET_KERNEL_DEFCONFIG := imx8_trucrux_android_defconfig


# Overrides
PRODUCT_NAME := trux_mx8mq_drm
...
TARGET_BOARD_DTS_CONFIG := \
	imx8mq-trux-q01-8MDVP-wifi-mipi:imx8mq-trux-q01-8MDVP-wifi-mipi.dtb \
	imx8mq-trux-q01-8MDVP-wifi-hdmi:imx8mq-trux-q01-8MDVP-wifi-hdmi.dtb \
	imx8mq-trux-q01-8MDVP-sd-mipi:imx8mq-trux-q01-8MDVP-sd-mipi.dtb \
	imx8mq-trux-q01-8MDVP-sd-hdmi:imx8mq-trux-q01-8MDVP-sd-hdmi.dtb
